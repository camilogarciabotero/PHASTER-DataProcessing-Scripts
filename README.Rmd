...
## Fig S1. Generating the dataset of the intact prophages in each bacterial species and visualizing on a bubble-plot.
...
```{r phage_families, message=FALSE, echo=FALSE}
...
The previous table is then joined to the main dataset and complements it
